 ...
 */
static awlf_ret_t stm32_serial_configure(hal_serial_t serial, serial_cfg_t cfg)
{
 ...
 */
static awlf_ret_t stm32_serial_putByte(hal_serial_t serial, uint8_t data)
{
    stm32_serial_t handle = (stm32_serial_t)serial;
 ...
 */
static uint8_t stm32_serial_getByte(hal_serial_t serial)
{
    stm32_serial_t handle = (stm32_serial_t)serial;
...
static awlf_ret_t stm32_serial_control(hal_serial_t serial, uint32_t cmd, void* arg) 
{
...
static size_t stm32_serial_transmit(hal_serial_t serial, const uint8_t* data, size_t length) {
    stm32_serial_t handle;
